...
//        String dateString1 = DateFormat.format("E, dd MMM yy", new Date(millisecond)).toString();
        ...
        holder.BlogFollowUser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(context,"You have followed"+ holder.userName.getText().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            BlogFollowUser = mview.findViewById(R.id.blog_follow);
